...
label ending:
    ...
    nvl clear
    n "{i}The end!{/i}"
    n "{color=#FFFF00}Writers:{/color} Jaden Nguyen (Lead Writer), Katie Sanchez (Writer)"
    n "{color=#FFFF00}Artists:{/color} Chloe Choi (CG Artist), Bao-Nhi Nguyen (Sprite Artist)"
    n "{color=#FFFF00}Programmers:{/color} Grace Seeberger, Jaden Nguyen"
    n "{color=#FFFF00}Project Manager:{/color} Jaden Nguyen"
    n "Thank you for playing! Please support Studio Yurika!! ^_^"
    stop music fadeout 1.0
