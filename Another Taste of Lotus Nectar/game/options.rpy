...
define config.name = _("Another Taste of Lotus Nectar")
...
define build.name = "AnotherTasteofLotusNectar"
...
define config.save_directory = "AnotherTasteofLotusNectar-1768532990"
